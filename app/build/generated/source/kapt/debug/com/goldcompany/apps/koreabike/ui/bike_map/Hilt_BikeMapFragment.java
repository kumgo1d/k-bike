 ...
 */
public abstract class Hilt_BikeMapFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BikeMapFragment() {
    super();
  }

  Hilt_BikeMapFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BikeMapFragment_GeneratedInjector) this.generatedComponent()).injectBikeMapFragment(UnsafeCasts.<BikeMapFragment>unsafeCast(this));
    }
  }
