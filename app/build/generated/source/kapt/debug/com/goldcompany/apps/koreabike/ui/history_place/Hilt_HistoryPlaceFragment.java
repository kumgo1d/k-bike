 ...
 */
public abstract class Hilt_HistoryPlaceFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HistoryPlaceFragment() {
    super();
  }

  Hilt_HistoryPlaceFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HistoryPlaceFragment_GeneratedInjector) this.generatedComponent()).injectHistoryPlaceFragment(UnsafeCasts.<HistoryPlaceFragment>unsafeCast(this));
    }
  }
