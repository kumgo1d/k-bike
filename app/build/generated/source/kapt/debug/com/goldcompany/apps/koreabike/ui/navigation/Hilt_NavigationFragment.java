 ...
 */
public abstract class Hilt_NavigationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NavigationFragment() {
    super();
  }

  Hilt_NavigationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NavigationFragment_GeneratedInjector) this.generatedComponent()).injectNavigationFragment(UnsafeCasts.<NavigationFragment>unsafeCast(this));
    }
  }
